            ...
            {wsCreateMode ? (
              <form className={navOpen ? 'flex-1 min-w-0' : 'w-full'} onSubmit={async (e) => {
                ...
                <input
                  ...
                  placeholder="Name..."
                  className="w-full px-2 py-1.5 text-[11px] rounded-lg border outline-none"
                  style={{
              ...
              <button title="New Workspace"
                ...
                style={{
                  ...
                  border: `1.5px dashed ${dark ? 'rgba(255,255,255,0.12)' : 'rgba(44,40,37,0.15)'}`,
                }}
