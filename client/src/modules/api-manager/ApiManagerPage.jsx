  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 mb-6 sm:mb-8 stagger">
        {[{ l: 'ACTIVE KEYS', v: String(activeKeys) }, { l: 'TOTAL REQUESTS', v: totalRequestsDisplay }, { l: 'AVG RESPONSE', v: avgResponse }, { l: 'RATE LIMIT USAGE', v: rateLimitPct }].map((s, i) => (<div key={i} className="panel stat-card rounded-2xl p-4 sm:p-6"><p className="hud-label text-[10px] mb-2">{s.l}</p><p className="text-2xl sm:text-3xl font-bold text-white font-mono tabular-nums leading-none">{s.v}</p></div>))}
      </div>
