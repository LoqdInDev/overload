...
export default function WorkflowBuilderPage() {
  ...
  const generate = async (template) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/workflow-builder/generate`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ type: 'content', prompt: template.prompt }) });
