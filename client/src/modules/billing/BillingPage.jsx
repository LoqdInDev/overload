      ...
      {tab === 'usage' && (
        <div className="animate-fade-in space-y-4 sm:space-y-6">
          <div className="panel rounded-2xl p-4 sm:p-7">
            <p className="hud-label text-[11px] mb-4 sm:mb-6" style={{ color: MODULE_COLOR }}>AI GENERATION USAGE</p>
                ...
                <div key={u.module}>
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold text-gray-300">{u.module}</span>
                    </div>
            ...
            <div className="mt-7 pt-6 border-t border-indigo-500/[0.06]">
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-gray-400">Total Used</span>
          ...
          {(generating || output) && (
            <div className="panel rounded-2xl p-4 sm:p-7">
              <div className="flex items-center gap-3 mb-4">
                <div className={`w-2.5 h-2.5 rounded-full ${generating ? 'animate-pulse' : 'bg-emerald-400'}`} style={{ background: generating ? MODULE_COLOR : undefined }} />
