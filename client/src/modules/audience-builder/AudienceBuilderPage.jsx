...
export default function AudienceBuilderPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-12">
      <div className="mb-6 sm:mb-8 animate-fade-in"><p className="hud-label text-[11px] mb-2" style={{ color: '#8b5cf6' }}>AUDIENCE BUILDER</p><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-1">Audience Builder</h1><p className="text-base text-gray-500">Build, manage, and optimize audiences across platforms</p></div>
