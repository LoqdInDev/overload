...
const FALLBACK_APPROVALS = [
  { id: 'fallback-1', moduleId: 'content', title: 'Blog Post: 7 Email Subject Line Formulas That Drive Opens', description: 'AI-generated blog post based on trending keyword analysis. 1,200 words with SEO-optimized headers.', priority: 'high', confidence: 89, status: 'pending', createdAt: new Date(Date.now() - 3600000).toISOString(), payload: { headline: '7 Email Subject Line Formulas That Drive Opens', word_count: 1200, seo_score: 92 } },
  { id: 'fallback-2', moduleId: 'social', title: 'Instagram Carousel: Spring Collection Launch', description: 'Multi-slide carousel showcasing new spring products with engagement-optimized captions.', priority: 'urgent', confidence: 94, status: 'pending', createdAt: new Date(Date.now() - 7200000).toISOString(), payload: { platform: 'instagram', format: 'carousel', slides: 5 } },
  { id: 'fallback-3', moduleId: 'ads', title: 'Meta Ads Budget Increase for ROAS Campaign', description: 'ROAS exceeded 4.2x threshold. Recommending 15% budget increase on top-performing ad sets.', priority: 'high', confidence: 87, status: 'pending', createdAt: new Date(Date.now() - 14400000).toISOString(), payload: { current_budget: 500, recommended: 575, roas: 4.2 } },
  { id: 'fallback-4', moduleId: 'email-sms', title: 'Welcome Drip Sequence for New Subscribers', description: '3-email welcome series with A/B subject lines targeting 847 new subscribers this week.', priority: 'medium', confidence: 76, status: 'pending', createdAt: new Date(Date.now() - 28800000).toISOString(), payload: { emails: 3, recipients: 847, ab_variants: 2 } },
  { id: 'fallback-5', moduleId: 'seo', title: 'Meta Tag Updates for 12 Product Pages', description: 'AI detected underperforming title tags. Suggested revisions target high-volume keywords.', priority: 'medium', confidence: 82, status: 'pending', createdAt: new Date(Date.now() - 43200000).toISOString(), payload: { pages: 12, avg_volume: 2400 } },
  { id: 'fallback-6', moduleId: 'reviews', title: 'Auto-Response to 5-Star Google Review', description: 'Personalized response drafted for Sarah M.\'s 5-star review mentioning product quality.', priority: 'low', confidence: 91, status: 'pending', createdAt: new Date(Date.now() - 57600000).toISOString() },
];
