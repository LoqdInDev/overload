...
const CHAPTERS = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'The left sidebar organizes all 41 modules into categories: Create, Advertise, Analyze, Manage, Connect, Automate, and Settings. Click any module to open it. The sidebar collapses on smaller screens — use the hamburger menu to toggle it. Your 3 most-used modules appear at the top for quick access.',
      },
      {
  ...
  },
  {
    ...
    intro: 'Manage your team, configure automation safety limits, and customize how Overload works for your business.',
    steps: [
      {
        title: 'Team Management',
        text: 'Invite team members with different roles — Admin, Editor, or Viewer. Admins can change automation modes and settings. Editors can create and approve content. Viewers have read-only access to dashboards and reports. Manage permissions per module for granular control.',
        path: '/team',
        cta: 'Open Team',
      },
      {
        title: 'Client Manager',
        text: 'If you manage marketing for multiple clients (agency use), the Client Manager lets you organize brands, switch between client workspaces, and track deliverables. Each client gets isolated data, brand profiles, and integrations.',
        path: '/client-manager',
    ...
    tip: 'Pro tip: Set up Automation Settings before enabling any Autopilot modules. The safety limits (max actions/day, budget cap) give you a safety net while the AI operates autonomously.',
  },
];
          ...
          <div className="hidden lg:flex flex-col gap-1 w-[240px] flex-shrink-0 pt-4 overflow-y-auto no-scrollbar">
            ...
            <div className="mt-4 px-3 py-3 rounded-xl" style={{ background: dark ? 'rgba(94,142,110,0.08)' : 'rgba(94,142,110,0.06)', border: `1px solid ${dark ? 'rgba(94,142,110,0.15)' : 'rgba(94,142,110,0.1)'}` }}>
              ...
              <p style={{ fontSize: 11, color: t2, lineHeight: 1.5, fontFamily: dmSans }}>
                Brand Hub → Integrations → Content Creator → Autopilot
              </p>
            </div>
          </div>
