    ...
    steps: [
      {
        ...
        text: 'When you log in, you land on the Command Center — your mission control. It shows a live operations feed of all AI actions, pending approvals, module status across all 36 tools, and daily KPIs. Think of it as the nervous system of your entire marketing stack.',
        path: '/dashboard',
